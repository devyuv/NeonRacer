...
import {HUD, updateHUD} from "../ui/HUD.js";
...
export class Game {
 constructor(root,save,audio,onResult,onMenu){
  ...
  this.keys=new KeyboardControls();this.touch=new TouchControls(root.querySelector("#controls"));this.hud=root.querySelector("#hud");this.hud.innerHTML=HUD();
